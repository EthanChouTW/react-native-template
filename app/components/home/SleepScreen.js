...
export default class SleepScreen extends Component {
  ...
  render() {
    ...
    const renderDaySleepView = () => {
      if (isConnectDevice) {
        const { date, totalTime, totalPoint } = this.state;
        return (
          <View style={styles.dayTable}>
            <View style={styles.row}>
              <Text style={styles.rowTitle}>睡眠日期</Text>
              <Text style={styles.rowSubtitle}>{date}</Text>
            </View>
            <View style={styles.bottomLine} />
            <View style={styles.row}>
              <Text style={styles.rowTitle}>睡眠時間</Text>
              <Text style={styles.rowSubtitle}>{`${totalTime} 分鐘`}</Text>
            </View>
            <View style={styles.bottomLine} />
            <View style={styles.row}>
      ...
      return (
        <View style={styles.dayContainer}>
          <Text style={styles.dayDescription}>請點擊下方加號新增睡眠記錄</Text>
          <Text style={styles.dayDescription}>開始睡覺吧！</Text>
          {renderBottomButton()}
        </View>
      );
    };
